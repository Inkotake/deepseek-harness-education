 ...
 *    all CSS, all .glb/.gltf/.bin and the three largest remaining files are compared;
...
function finish(result) {
  ...
  return {
    ...
    note: htmlNotCompared.length
      ? `SHA-256 comparison of GET responses: ${verified} of ${required} resources were hash-verified, ${presenceChecked} HTML resource(s) were presence-checked only (htmlPolicy=${result.htmlPolicy}). No browser rendering was performed.`
      : 'SHA-256 comparison of GET responses; no browser rendering was performed.'
  };
}
