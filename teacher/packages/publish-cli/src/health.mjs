 ...
 *
 * State lives in `<TEACHER_DSH_HOME>/publish-provider-health.json` and never in the installation
 * directory. The breaker exists to stop `deploy` from hammering a host that is down: DNS failure
...
export const HEALTH_FILE_NAME = 'publish-provider-health.json';
