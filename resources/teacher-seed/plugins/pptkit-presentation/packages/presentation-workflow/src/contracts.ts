...
export interface ChartLegendPlan {
  visible?: boolean;
...
export interface ChartValueAxisPlan extends ChartAxisPlan {
  scale?: "auto" | { min: number; max: number; majorUnit: number };
}

export interface ChartAxesPlan {
  category?: ChartAxisPlan;
  value?: ChartValueAxisPlan;
}
...
export interface LineChartSeriesPlan extends ChartSeriesPlan {
  marker?: "auto" | false | ChartMarkerShape;
}

interface ChartPlanBase<TSeries extends ChartSeriesPlan> {
  categories: string[];
  series: TSeries[];
  legend?: ChartLegendPlan;
}

export interface BarChartPlan extends ChartPlanBase<ChartSeriesPlan> {
  type: "bar";
...
export interface LineChartPlan extends ChartPlanBase<LineChartSeriesPlan> {
  type: "line";
  axes?: ChartAxesPlan;
}

export interface PieChartPlan extends ChartPlanBase<ChartSeriesPlan> {
  type: "pie";
  axes?: never;
}

export type ChartPlan = BarChartPlan | LineChartPlan | PieChartPlan;
