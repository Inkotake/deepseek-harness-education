// Packs @teacher-dsh/artifact-sdk into packages/artifact-cli/vendor/artifact-sdk.tgz
// so teacher-artifact init can create projects without internet access.
...
const r = spawnSync('pnpm', ['pack', '--pack-destination', vendorDir], {
  cwd: sdkDir,
  shell: true,
  stdio: 'inherit'
});
...
// Normalize to a stable name for the CLI.
...
const packed = path.join(vendorDir, files[0]);
