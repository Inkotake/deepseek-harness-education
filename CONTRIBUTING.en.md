...
- Join the [upstream DSH Desktop community channels](https://github.com/anywhere-labs/dsh-desktop) (WeChat group, QQ group, Discord) and help other users.
- Write tutorials or experience posts, or help improve and translate the documentation.
- Suggest ecosystem projects for the upstream project's related-links section.
